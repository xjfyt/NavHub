...
> **对应代码**：`backend/src/handlers/wallpapers.rs`、`backend/src/handlers/admin/wallpapers.rs`、`backend/src/scraper/`、`frontend/src/components/WallpaperPicker.tsx`
...
interface RemoteWallpaperItem {
  ...
  title: string | null;
  url: string;              // MinIO 存储的 URL 或原始 URL
