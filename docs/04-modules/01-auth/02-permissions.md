...
> **对应代码**：`backend/src/auth/mod.rs`、`backend/src/models/user.rs`
> **维护提示**：修改角色权限逻辑时同步更新本文档。
...
- 下一篇：[02-database/01-overview.md](../02-database/01-overview.md)
- 返回索引：[docs/README.md](../../README.md)# 角色与权限
