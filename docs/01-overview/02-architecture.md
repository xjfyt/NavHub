...
> **对应代码**：`backend/src/`、`frontend/src/`、`Dockerfile`
> **维护提示**：架构变更时同步更新本文档。
...
见 [04-modules/01-auth/02-permissions.md](../04-modules/01-auth/02-permissions.md).
...
- 返回索引：[docs/README.md](../README.md)# NavHub 架构文档
