...
export const Icon = ({ name, size = 18, stroke = 1.8, ...rest }: IconProps) => {
  ...
  switch (name) {
    ...
    case "tool":
      return (
        <svg {...props}>
          <path d="M14.7 6.3a4 4 0 00-5.4 5.4l-6 6a1 1 0 000 1.4l1.6 1.6a1 1 0 001.4 0l6-6a4 4 0 005.4-5.4l-2.1 2.1-2.5-2.5 2.6-2.6z" />
        </svg>
      );
    case "play":
      return (
    ...
    case "cloud":
      return (
        <svg {...props}>
          <path d="M18 10a5 5 0 00-9.8-1.3A4 4 0 007 17h10a4 4 0 001-7z" />
        </svg>
      );
    case "heart":
      return (
    ...
    case "key":
      return (
        <svg {...props}>
          <path d="M21 2l-2 2m-7.6 7.6a5.5 5.5 0 11-7.8 7.8 5.5 5.5 0 017.8-7.8zm0 0L15.5 8M22 3L19 6m-2 2l3 3" />
        </svg>
      );
    case "send":
      return (
    ...
    case "phone":
      return (
        <svg {...props}>
          <path d="M22 16.9v3a2 2 0 01-2.2 2 19.8 19.8 0 01-8.6-3.1 19.5 19.5 0 01-6-6 19.8 19.8 0 01-3.1-8.7A2 2 0 014.1 2h3a2 2 0 012 1.7c.1.9.3 1.8.6 2.6a2 2 0 01-.5 2.1L8 9.6a16 16 0 006 6l1.3-1.3a2 2 0 012.1-.4c.8.3 1.7.5 2.6.6a2 2 0 011.7 2z" />
        </svg>
      );
    case "video":
      return (
    ...
    case "wallet":
      return (
        <svg {...props}>
          <path d="M20 12V8H4a2 2 0 010-4h12v4" />
          <path d="M20 12v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6" />
    ...
    case "gamepad":
      return (
        <svg {...props}>
          ...
          <path d="M17.3 5H6.7A4.7 4.7 0 002 9.7v4.6A4.7 4.7 0 006.7 19c1.4 0 2.7-.6 3.6-1.6l1-1.4h3.4l1 1.4c.9 1 2.2 1.6 3.6 1.6a4.7 4.7 0 004.7-4.7V9.7A4.7 4.7 0 0017.3 5z" />
        </svg>
      );
    case "gift":
      return (
    ...
    case "mascot":
      return (
        <svg {...props}>
          <circle cx="6.4" cy="6.8" r="2.7" fill="currentColor" stroke="none" />
          <circle
            cx="17.6"
            cy="6.8"
            r="2.7"
          ...
          <circle cx="9.5" cy="13" r="0.95" fill="currentColor" stroke="none" />
          <circle
            cx="14.5"
            cy="13"
            r="0.95"
            ...
            stroke="none"
          />
          <path d="M9 16.6c1.2 1.4 4.8 1.4 6 0" />
        </svg>
      );
    default:
      return (
