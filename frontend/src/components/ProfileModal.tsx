    ...
    <>
      ...
      <Modal
        ...
        contentStyle={{
          ...
          color: "var(--text)",
          boxShadow:
            "0 24px 48px rgba(0,0,0,0.2), inset 0 1px 0 var(--glass-border-soft)",
        }}
      >
        <button
          onClick={onClose}
          ...
          >
            <div
              ...
              style={{
                ...
                boxShadow:
                  "0 8px 24px rgba(0,0,0,0.15), inset 0 1px 1px var(--glass-border-soft)",
                width: 86,
                height: 86,
                fontSize: 36,
                fontWeight: 700,
        ...
        <div
          style={{
            ...
            borderRadius: 16,
            border: "1px solid var(--glass-border-soft)",
            boxShadow: "inset 0 1px 0 var(--glass-border-soft)",
          }}
        >
          <div
            style={{
          ...
          >
            ...
            <span
              style={{
                color: "var(--ok)",
                fontWeight: 600,
                background: "rgba(62,190,120,0.15)",
                padding: "4px 10px",
                borderRadius: 8,
              }}
            >
