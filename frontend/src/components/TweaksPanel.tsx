...
const wallpaperImagePreviewUrl = (
    ...
    return (
      <div className="tw-content">
        ...
        <div className="tw-section">
          ...
          <div className="tw-section-card">
            <Row label="用户协议" onClick={() => setDocModal("terms")}>
              <Chevron />
            </Row>
            <Row label="隐私政策" onClick={() => setDocModal("privacy")}>
              <Chevron />
            </Row>
          </div>
        </div>
