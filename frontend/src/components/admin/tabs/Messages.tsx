...
import type { AdminMessage, AdminUser, MessageLevel, MessageTargetType } from "../../../types";
import {
  MESSAGE_LEVELS,
  MESSAGE_TARGETS,
  PUSHABLE_ROLES,
  ...
  return (
    <>
      <div
        ...
        style={{ marginBottom: 30, display: "flex", justifyContent: "space-between", gap: 16 }}
      >
        <div>
          <h2 style={{ fontSize: 24, margin: "0 0 6px 0" }}>消息推送</h2>
          <div style={{ fontSize: 13, color: "var(--text-soft)" }}>
            向指定用户、角色或全体用户下发系统通知，用户可在“偏好设置 → 消息通知”查看。
          </div>
        </div>
      ...
      >
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
              <div>
                ...
                <select
                  style={inputStyle}
                  value={form.level}
                  onChange={(e) => setForm((s) => ({ ...s, level: e.target.value as MessageLevel }))}
                >
        ...
        <div
          ...
          style={{ padding: 20, borderRadius: 16, minHeight: 420, opacity: loading ? 0.7 : 1 }}
        >
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", gap: 12, alignItems: "start" }}>
                    <div style={{ minWidth: 0 }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8, flexWrap: "wrap" }}>
                        <span
                          style={{ ...levelBadgeStyle(msg.level), padding: "3px 8px", borderRadius: 999, fontSize: 11 }}
                        >
                      ...
                      >
                        ...
                        {msg.linkUrl ? (
                          <a href={msg.linkUrl} target="_blank" rel="noreferrer" style={{ color: "var(--accent)" }}>
                            附带链接
                          </a>
                        ) : null}
                      </div>
