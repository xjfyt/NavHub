...
import { WallpaperGrid } from "./wallpaper-library/WallpaperGrid";
  ...
  return (
    <div>
      ...
      <WallpaperGrid
        ...
        onPrevPage={() => setWallpaperPage((p) => Math.max(0, p - 1))}
        onNextPage={() => setWallpaperPage((p) => p + 1)}
      />
