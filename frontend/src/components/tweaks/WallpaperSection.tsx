...
export const WallpaperSection = ({
  ...
  updateTweaks,
  remoteWallpapers,
  remoteWallpaperTotal,
  remoteWallpapersLoading,
  wallpaperSearch,
  setWallpaperSearch,
  wallpaperMediaFilter,
  setWallpaperMediaFilter,
  ...
  remoteWallpapers: RemoteWallpaperItem[];
  remoteWallpaperTotal: number;
  remoteWallpapersLoading: boolean;
  wallpaperSearch: string;
  setWallpaperSearch: React.Dispatch<React.SetStateAction<string>>;
  wallpaperMediaFilter: "" | "image" | "video";
  setWallpaperMediaFilter: React.Dispatch<
    React.SetStateAction<"" | "image" | "video">
  >;
  wallpaperSourceFilter: string;
  setWallpaperSourceFilter: React.Dispatch<React.SetStateAction<string>>;
  wallpaperSources: PublicWallpaperSource[];
  wallpaperPage: number;
  setWallpaperPage: React.Dispatch<React.SetStateAction<number>>;
  detailWallpaper: RemoteWallpaperItem | null;
      ...
      <div className="tw-section">
        ...
        <div className="tw-wallpaper-hero">
          <WallpaperPreview
            ...
            className={
              "tw-wallpaper-preview" + (active || themeActive ? " active" : "")
            }
            emptyText={
              shuffleOn
